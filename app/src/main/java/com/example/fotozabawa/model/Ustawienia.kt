...
data class Ustawienia (
    ...
    @ColumnInfo (name="piosenka_position")var piosenka_position: Int?,
    ...
    @Ignore
    constructor(czas: Int,czas_position: Int, piosenka_position: Int?,tryb: Int,banner: String?,tryb_position: Int?) : this (null, czas,czas_position, piosenka_position,tryb,banner,tryb_position)
}